...
/**
 * The WhisperTestApp is used to run a simple speech to text execution using the native Java functions described
 * in Whisper.java, using a known audio input.
 */
public class WhisperTestApp {
    ...
    public void testInference() {
        ...
        String transcribed = whisper.fullTranscribe(context, 2, audioData);

        String expected = " And so my fellow Americans, ask not what your country can do for you, ask what you can do for your country.";
        assertTrue("Expected: [" + expected + "] but was [" + transcribed + "]", transcribed.equals(expected));
    }
